...
public class CrewFragment extends SearchFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mQueryHandler.startQuery(TOKEN_GROUP, null,
				SyncedContentProvider.SEARCH_URI, SEARCH_PROJECTION,
				Search.SIDE + "=" + Search.VALUE_SEEK, null, SORTED_ORDER);
